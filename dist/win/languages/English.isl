...
; *** Common wizard text
ClickNext=Click Install Atraci to continue, or Cancel to exit Setup.
BeveledLabel=
...
; *** "Welcome" wizard page
WelcomeLabel1=You're about to get some Atraci!
WelcomeLabel2=This will install [name/ver] on your computer.%n%nKeep in mind that Atraci is in Beta and we make no guarantees, so use it at your own risk.
